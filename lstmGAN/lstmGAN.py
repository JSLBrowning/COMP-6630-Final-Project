...
from tensorflow.keras.layers import Dropout, LeakyReLU, Input, Dense, Bidirectional, LSTM, \
...
class LSTMGAN:
    ...
    def build_generator(self):
        ...
        model.add(Bidirectional(LSTM(self.dl.getUniqueWordCount(), return_sequences=True),
                                input_shape=(self.dl.getMaxDimension(), self.dl.getMaxDimension())))
    ...
    def build_discriminator(self):
        ...
        model.add(Bidirectional(LSTM(self.dl.getUniqueWordCount(), activation='relu', return_sequences=True),
                                input_shape=(pow(self.dl.getMaxDimension(), 2), 1)))
        model.add(LeakyReLU(alpha=0.2))
